...
function ExpenseTable() {
  const { FilterDataOption, Total, setSelect, setInputFormData, InputFormData } = useContext(ExpenseStore);
                    ...
                    <div className="flex flex-col sm:flex-row sm:items-center sm:gap-5">
                      ...
                      <div className="flex gap-2 mt-1 sm:mt-0">
                        <FaArrowUpLong
                          ...
                          onClick={() => setInputFormData((pre) => [...pre].sort((a, b) => a.amount - b.amount))}
                        />
                        <FaArrowDownLong
                          className="text-lg hover:cursor-pointer"
                          onClick={() => setInputFormData((pre) => [...pre].sort((a, b) => b.amount - a.amount))}
                        />
                      </div>
                    </div>
                  </th>
